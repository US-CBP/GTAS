...
const PaxDetail = (props) => {
  ...
  const tabs = [{ title: 'Summary', link: tabcontent[0] }, { title: 'APIS', link: tabcontent[1] },
  { title: 'PNR', link: tabcontent[2] }, { title: 'Flight History', link: tabcontent[3] }, { title: 'Link Analysis', link: tabcontent[4] }];
return (
