...
describe('Table', () => {
  it('renders without crashing', () => {
    ReactDOM.render(<Table uri={fake} id={fake} service={callback} callback={callback}/>, div);
    ReactDOM.unmountComponentAtNode(div);
  });

  it('accepts a data array without crashing', () => {
    const data = [{id: 2, code: 'sjeu', userName: 'Yogi'}, {id: 10, code: 'sjeu', userName: 'Yogi'}, {id: 1, code: 'sjeu', userName: 'Yogi'}];
