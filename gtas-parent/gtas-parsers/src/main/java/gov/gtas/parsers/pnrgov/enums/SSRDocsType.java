...
public enum SSRDocsType {
    ...
    /*
    * Order matches the spec doc. DO NOT CHANGE ORDER AS WE PICK WHICH DOCUMENT TO CREATE A PASSENGER WITH BY
    * REVERSED ORDER OF THIS ENUM.
    *
    * */
    ...
    private static final Map<String, SSRDocsType> stringToEnum =
