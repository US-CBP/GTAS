...
public enum PhoneCodes {
	...
	private static final Map<String, PhoneCodes> stringToEnum = Stream.of(values())
	...
	public static boolean textContainsPhoneNumberString(String txt) {
		return txt.contains(HOME_PHONE_A.toString()) || txt.contains(HOME_PHONE_B.toString())
				|| txt.contains(BUSINESS_PHONE_A.toString()) || txt.contains(BUSINESS_PHONE_B.toString())
				|| txt.contains(MOBILE_PHONE_A.toString()) || txt.contains(MOBILE_PHONE_B.toString())
				|| txt.contains(TRAVEL_AGENT_PHONE_A.toString()) || txt.contains(TRAVEL_AGENT_PHONE_B.toString())
				|| txt.contains(PHONE_NATURE_NOT_KNOWN_A.toString())
				|| txt.contains(PHONE_NATURE_NOT_KNOWN_B.toString()) || txt.contains(DATA_FAX_PHONE_A.toString())
