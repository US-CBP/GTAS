...
public class SSRDocs {
    ...
    private void populateSSRDocs() {
        ...
        //Follow the Passenger Travel Documentation Information AIRIMP32 pg 146 grammar. Follows the same path split on the "/".
        /*
        * Use following order, starting at 1(this is predicated by a /):
        * 1 : Travel Document Type
        * 2 : Travel Document Issuing Country/State
        * 3 : Travel Document Number
        * 4 : Passenger Nationality
        * 5 : Date of Birth DDMMMYY
        * 6 : Gender of passenger
        * 7 : Travel Document Expiry Date
        * 8 : Travel Document Surname
        * 9 : Travel Document First Given Name
        * 10 : Travel Document Second Given Name
        * 11: If multi-passenger passport and this SSR is the primary passport include the letter H
        * 12: Name information - e.g. follow with a hyphen.
        * */
        ...
        for (int i = 0; i < freeTextInArrayForm.length; i++) {
            ...
            switch (i) {
                ...
                case 10:
                    ...
                    break;
                case 11: this.holder = "H".equalsIgnoreCase(subSegment);
                    break;
                case 12: this.nameInformationLine = subSegment;
                    break;
                default:
