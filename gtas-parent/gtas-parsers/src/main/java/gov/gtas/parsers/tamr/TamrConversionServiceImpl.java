...
public class TamrConversionServiceImpl implements TamrConversionService {
	...
	// Convenience method. Receives list of Flights to convert to send objects for
	// batch dump uses other single flight method
	...
	private List<TamrPassengerSendObject> convertGTASFlightAndPassengersToTamrMessage(Flight flight,
	...
	public void sendPassengersToTamr(Set<Flight> flights, Set<Passenger> passengers) {
		...
		try {
			// Commented out for commit, uncomment with new Tamr credentials if wanting to
			// use.
