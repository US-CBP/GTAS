...
public final class TextUtils {
	 ...
	 * escaped with 'escape' character. For example, if we call this method with s =
	 * "mc?'foo'bar", delimiter = '\'', escape = '?' the method should return
	 * ["mc'foo", "bar"]. Note as a side-effect, the escape characters are removed
	 ...
	 *            input string
	 * @param encoding
	 *            character encoding of the input string
