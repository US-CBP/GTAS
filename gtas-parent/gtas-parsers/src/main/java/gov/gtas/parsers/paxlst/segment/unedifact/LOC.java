...
public class LOC extends Segment {
	public enum LocCode {
		// DTM
		DEPARTURE_AIRPORT, ARRIVAL_AIRPORT, BOTH_DEPARTURE_AND_ARRIVAL_AIRPORT, FINAL_DESTINATION, FILING_LOCATION, REPORTING_LOCATION, GATE_PASS_LOCATION,

		// NAD
		AIRPORT_OF_FIRST_US_ARRIVAL, COUNTRY_OF_RESIDENCE, PORT_OF_EMBARKATION, PORT_OF_DEBARKATION, PLACE_OF_BIRTH,
