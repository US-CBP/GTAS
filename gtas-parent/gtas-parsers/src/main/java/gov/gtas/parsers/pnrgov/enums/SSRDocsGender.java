...
public enum SSRDocsGender {
    ...
    MALE_PASSENGER("M"),
    UNDISCLOSED("U"),
    //Not provided is not in spec doc. This is to help distinguish between Undisclosed and a not given gender.
    NOT_PROVIDED("VV");
    ...
    private static final Map<String, SSRDocsGender> stringToEnum =
