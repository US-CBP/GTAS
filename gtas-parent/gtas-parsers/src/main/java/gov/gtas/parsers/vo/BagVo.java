...
public class BagVo {
	...
	public boolean hasSameBagInfo(Bag bag) {
		...
		if (!objectsAreBothNullOrNotNull(bagMeasurements, VoMeasurements))
			return false;
		...
		return sameCount && sameWeight && sameAirline && sameDestination && sameId && sameConseqId;
	}
