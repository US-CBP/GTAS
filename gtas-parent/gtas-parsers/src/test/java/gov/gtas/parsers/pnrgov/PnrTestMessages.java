...
public class PnrTestMessages {
   ...
   public static String fullPnrMessagePg77() {
        return pnrStart + pnrBodyPg77 + endPnr;
    }

    public static String fullPnrMessagePg76() {
        return pnrStart + getPnrBodyPg76 + endPnr;
    }
   ...
   private static String pnrBodyPg77 =
           "SRC'\n" +
           ...
           "DAT+700:230513:2125+710:230513:2124'" +
            ...
            "TVL+310513::310513+OOL+SIN+TZ+0005:S'\n" +
            "RPI+1+HK" +
            "IFT+4:19+GN FROM NONE TO ACME TEAM PARTY'\n";



   private static String getPnrBodyPg76 =
           "SRC' \n" +
           "RCI+1A:35K2IO::150213:0149+1S:EVFSDI' \n" +
           "DAT+700:270513:1354'\n" +
           "ORG+1A:MUC+:DFW1S4100++1S++CA+LHSU+7E5AA8+9B'\n" +
           "TIF+DORON:I+NINA MS::2'\n" +
           "REF+:00183511D94292CC'\n" +
           "SSR+DOCS:HK:1:LH::::://///05FEB53/F//DORON/NINA'\n" +
           "TKT+3204694511:T:4'  \n" +
           "DAT+710:140213' \n" +
           "TIF+LENDROT:I+CHARLOTTE MS::1' \n" +
           "REF+:00183511D94292CD'\n" +
           "SSR+DOCS:HK:1:LH::::://///14FEB52/F//LENDROT/CHARLOTTE'\n" +
           "TKT+3204694509:T:4'\n" +
           "DAT+710:170213'\n" +
           "TVL+270513:1550:270513:1820+MUC+YUL+LH+474:W'\n" +
           "RPI+2+HK'\n" +
           "APD+333'\n" +
           "RCI+1A:35K2IO::150213:0149+1S:EVFSDI'";

    private static String endPnr =
