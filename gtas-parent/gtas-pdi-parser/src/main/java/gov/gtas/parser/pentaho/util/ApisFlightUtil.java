...
/**
 * This class implements methods to compute or extract flight related
 * information from an input a string.
 *
 */
public class ApisFlightUtil {
	 ...
	 * @Param lastAirportInDestCtry The last airport in destination country
	 * @return int The number of flight legs
	 *
	 */

	public static Long getNumberOfFlightLegs(String firstAirportInDestCtry, String nextAirportInDestCtry,
			String lastAirportInDestCtry) {
	 ...
	 * 
	 * @return java.lang.String The character portion of the flightDesignator input,
	 *         which is the carrier code.
	 */
	 ...
	 *            Flight designator a.k.a carrier code + flight number
	 * 
	 * @return ava.lang.String The character portion of the flightDesignator input,
	 *         which is the carrier code.
	 */
