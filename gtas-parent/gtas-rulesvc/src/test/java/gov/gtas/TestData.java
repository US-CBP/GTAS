...
public class TestData {
	...
	public static Passenger getPassenger() {
		...
		passengerTripDetails.setPaxId(1L);
	...
	public static BookingDetail getBookingDetail() {
		...
		LocalDateTime bdEtd = LocalDateTime.of(2017, 3, 14, 10, 15);
		Date bdEtdDate = Date.from(bdEtd.atZone(ZoneId.systemDefault()).toInstant());
		bookingDetails.setEtd(bdEtdDate);
		bookingDetails.setFlight(getFlight());
	...
	public static List<Pnr> getPnrList() throws SQLException {
		...
		flightLeg.setBookingDetail(getBookingDetail());
	...
	public static Pnr getPnrMessage() throws SQLException {
		return getPnrList().get(0);
	}
	...
	public static DwellTime getDwell() {
		DwellTime dwellTime = new DwellTime();
		dwellTime.setId(1L);
		dwellTime.setFlyingFrom("here");
		dwellTime.setFlyingTo("there");
		dwellTime.setId(1L);
		return dwellTime;
	}
	...
	public static PaymentForm getPayment() {
		...
		paymentForm.setId(1L);
		paymentForm.setWholeDollarAmount(350);
		paymentForm.setPaymentAmount("350.00");
		paymentForm.setPaymentType("CA");
		return paymentForm;
	}
