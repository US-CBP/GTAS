...
public class RuleTemplateConstants {
	...
	// Field Names coming from the query builder have different format than needed
	// for rule builder, this map syncs the naming conventions
	public static final Map<String, String> passTripDetailsMap = Collections
	...
	public static final Map<String, String> flightMutableDetailsMap = Collections
			.unmodifiableMap(new HashMap<String, String>() {
				{
	...
	public static final String GLOBAL_RESULT_DECLARATION = "global java.util.List "
