...
public class BookingDetailConditionBuilder extends EntityConditionBuilder {

	public BookingDetailConditionBuilder(final String drlVariableName) {
		super(drlVariableName, EntityEnum.BOOKING_DETAIL.getEntityName());
	}
