...
public class RuleEventListenerUtils {
	...
	private static final Logger logger = LoggerFactory.getLogger(RuleEventListenerUtils.class);
	 ...
	 */
	public static List<EventListener> createEventListeners(final RuleExecutionStatistics stats) {
