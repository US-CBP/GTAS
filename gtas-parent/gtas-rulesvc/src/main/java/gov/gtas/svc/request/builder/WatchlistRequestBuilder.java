...
/**
 * Watch list Request Builder constructs Rule Engine execution request for watch
 * lists from APIS and PNR messages. The constructed request contains all watch
 * list related objects (e.g., passenger, document) associated with the APIS and
 * PNR messages supplied. Duplicates are also removed in the construction
 * process.
 * 
 * @deprecated
 *
