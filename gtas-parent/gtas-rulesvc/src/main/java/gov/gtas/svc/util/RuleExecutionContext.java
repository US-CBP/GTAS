...
/**
 * This class is for objects that carry state information during Targeting
 * operations.
 */
public class RuleExecutionContext {
	...
	/**
	 * @param paxFlightTuples
	 *            the paxFlightTuples to set
	 */
	...
	/**
	 * @param ruleServiceRequest
	 *            the ruleServiceRequest to set
	 */
	...
	/**
	 * @param ruleExecutionStatistics
	 *            the ruleExecutionStatistics to set
	 */
