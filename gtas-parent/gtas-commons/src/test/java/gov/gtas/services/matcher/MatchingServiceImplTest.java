...
public class MatchingServiceImplTest {
	...
	public void before() {
		...
		matchingService = new MatchingServiceImpl(paxWatchlistLinkRepository, watchlistItemRepository,
				passengerRepository, watchlistRepository, caseDispositionService, flightFuzzyHitsRepository,
				passengerWatchlistRepository, appConfigRepository, passengerService, nameMatchCaseMgmtUtils);
	...
	public void testCaseCreation() {
		...
		ProcessedMatcherResults processedResults = matchingService.processMatcherResults(flight, passenger,
				matcherParameters, matchingResult);
