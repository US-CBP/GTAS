...
public class LocalToUTCServiceTest {
	...
	public void before() {
		...
		Mockito.when(airportService.getAirportByThreeLetterCode("IAD"))
				.thenReturn(AirportServiceImpl.buildAirportVo(iad));
		Mockito.when(airportService.getAirportByFourLetterCode("KIAD"))
				.thenReturn(AirportServiceImpl.buildAirportVo(iad));
	}
