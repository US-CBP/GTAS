...
public interface PassengerRepository extends JpaRepository<Passenger, Long>, PassengerRepositoryCustom {
	 ...
	 * ) List<Passenger> getPassengerByName(@Param("firstName") String
	 * firstName,@Param("lastName") String lastName);
	 * 
	 * @Query("SELECT p FROM Passenger p WHERE UPPER(p.lastName) = UPPER(:lastName)"
	 * ) List<Passenger> getPassengersByLastName(@Param("lastName") String
	 * lastName);
	 */
	 ...
	 * )MESSAGE RECEIVED FROM QUEUE: public List<Passenger>
	 * getPassengersByFlightId(@Param("flightId") Long flightId);
	 */
	 ...
	 * ) public List<Passenger> getPassengersByFlightId(@Param("flightId") Long
	 * flightId);
	 */
	 ...
	 * ) public List<Passenger> getPassengersByFlightIdAndName(@Param("flightId")
	 * Long flightId, @Param("firstName") String firstName,@Param("lastName") String
	 * lastName);
	 */
	...
	List<Disposition> getPassengerDispositionHistory(@Param("passengerId") Long passengerId,
	...
	// public List<Passenger> getNotNullIdTaggedPassenger(@Param("firstName") String
	// firstName, @Param("lastName") String lastName,
	...
	//
	/*
	 * @Query("SELECT p FROM Passenger p WHERE p.paxIdTag IS NULL") public
	 * List<Passenger> getNullIdTagPassengers();
	 * 
	 * @Query("SELECT p FROM Passenger p WHERE p.paxIdTag IS NOT NULL") public
	 * List<Passenger> getNotNullIdTagPassengers();
	 */
}
