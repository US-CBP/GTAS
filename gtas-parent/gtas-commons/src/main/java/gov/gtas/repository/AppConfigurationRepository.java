...
public interface AppConfigurationRepository extends CrudRepository<AppConfiguration, Long> {
    ...
    String SNS_NOTIFICATION_ARN = "SNS_NOTIFICATION_ARN";
    String INTERPOL_RED_NOTICE_ID = "INTERPOL_RED_NOTICE_ID";
    String ENABLE_HIT_NOTIFICATION = "ENABLE_HIT_NOTIFICATION";
