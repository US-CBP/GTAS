...
public class AirportVo {
    ...
    public AirportVo(Long id, Long originId, String name, String iata, String icao, String country, String city, BigDecimal latitude, BigDecimal longitude, Integer utcOffset, String timezone) {
        this.id = id;
