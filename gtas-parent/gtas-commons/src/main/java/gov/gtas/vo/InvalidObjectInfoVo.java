...
/**
 * class InvalidObjectInfoVo used to store invalid value object information and
 * store the same in database for verification and track the failed to load
 * objects due to insufficient information. This class is used in
 * MessageValidators and while validating the object graph the invalid object
 * will be set to null to avoid loading issues and the same will be copied into
 * this object which will be stored in database as InvalidObjectInfo
 */
