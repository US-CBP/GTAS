...
public class CaseComment extends BaseEntityAudit {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof CaseComment))
			return false;

		CaseComment that = (CaseComment) o;
		return Objects.equals(comment, that.comment) && commentType == that.commentType
	...
	public String toString() {
		return "CaseComment{" + "comment='" + comment + '\'' + ", commentType=" + commentType + " createdBy"
				+ getCreatedBy() + '}';
	}
}
