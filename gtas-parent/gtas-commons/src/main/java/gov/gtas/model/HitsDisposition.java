...
public class HitsDisposition extends BaseEntityAudit {
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		if (!(o instanceof HitsDisposition))
			return false;
		HitsDisposition that = (HitsDisposition) o;
		return this.getHitId() == that.getHitId() && ((this.getRuleType() == null ? that.getRuleType() == null
				: this.getRuleType().equalsIgnoreCase(that.getRuleType())));
	}
