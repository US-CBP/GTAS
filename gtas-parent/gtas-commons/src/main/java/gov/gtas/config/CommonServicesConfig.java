...
public class CommonServicesConfig {
	...
	private Properties hibProperties() {
		...
		properties.put(PROPERTY_NAME_SHAREDCACHE_MODE, env.getRequiredProperty(PROPERTY_NAME_SHAREDCACHE_MODE));
		properties.put(PROPERTY_NAME_HIBERNATE_USE_MINIMAL_PUTS,
				env.getRequiredProperty(PROPERTY_NAME_HIBERNATE_USE_MINIMAL_PUTS));
		properties.put(PROPERTY_NAME_HIBERNATE_JDBC_BATCH_SIZE,
				env.getRequiredProperty(PROPERTY_NAME_HIBERNATE_JDBC_BATCH_SIZE));
		properties.put(PROPERTY_NAME_HIBERNATE_USE_SQL_COMMENTS,
				env.getRequiredProperty(PROPERTY_NAME_HIBERNATE_USE_SQL_COMMENTS));
		...
		properties.put(PROPERTY_NAME_HIBERNATE_CHARACTERENCODING,
				env.getRequiredProperty(PROPERTY_NAME_HIBERNATE_CHARACTERENCODING));
	...
	public DataSource dataSource() {
		...
		dataSource
				.setIdleConnectionTestPeriod(Integer.parseInt(env.getRequiredProperty(PROPERTY_NAME_C3P0_MAX_CONNECT)));
		dataSource.setCheckoutTimeout(Integer.parseInt(env.getRequiredProperty(HIBERNATE_TIMEOUT)));
		return dataSource;
	}
