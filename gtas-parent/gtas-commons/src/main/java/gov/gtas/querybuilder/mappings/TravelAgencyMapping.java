...
public enum TravelAgencyMapping implements IEntityMapping {
	...
	private TravelAgencyMapping(String fieldName, String friendlyName, String fieldType, boolean displayField) {
	...
	private TravelAgencyMapping(String fieldName, String friendlyName, String fieldType) {
