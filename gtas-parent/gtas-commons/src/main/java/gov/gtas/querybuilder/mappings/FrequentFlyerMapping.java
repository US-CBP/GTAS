...
public enum FrequentFlyerMapping implements IEntityMapping {
	...
	private FrequentFlyerMapping(String fieldName, String friendlyName, String fieldType, boolean displayField) {
	...
	private FrequentFlyerMapping(String fieldName, String friendlyName, String fieldType) {
