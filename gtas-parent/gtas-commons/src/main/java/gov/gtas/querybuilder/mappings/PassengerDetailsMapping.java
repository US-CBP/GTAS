...
public enum PassengerDetailsMapping implements IEntityMapping {
	...
	PassengerDetailsMapping(String fieldName, String friendlyName, String fieldType, boolean displayField) {
	...
	PassengerDetailsMapping(String fieldName, String friendlyName, String fieldType) {
