...
public enum CreditCardMapping implements IEntityMapping {
	...
	private CreditCardMapping(String fieldName, String friendlyName, String fieldType, boolean displayField) {
	...
	private CreditCardMapping(String fieldName, String friendlyName, String fieldType) {
