...
public class FileServiceImpl implements FileService {
	...
	public File getLogZip(String logType, String logFile) {
		...
		try {
			...
			logger.error("FileServiceImpl.getLogZip - unable to send zip binary from '" + logPath + "\\" + logType
					+ "\\" + filename + "'. Directory must be set in application.properties. Error message: " + ex);
		}
		return null;
	}
