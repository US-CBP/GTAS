...
@Service
public class PassengerEventReportServiceImpl implements PassengerEventReportService {
	...
	private PassengerPdfService<PaxDetailPdfDocRequest, PaxDetailPdfDocResponse> passengerPdfService;
	...
	public PassengerEventReportServiceImpl(FlightService flightService,PnrService pnrService,PassengerService passengerService,HitDetailService hitDetailService,
			PassengerPdfService<PaxDetailPdfDocRequest, PaxDetailPdfDocResponse> passengerPdfService, HitDetailService hitsDetailsService, PassengerNoteService passengerNoteService)
	{
		this.flightService = flightService;
		this.pnrService = pnrService;
		this.passengerService = passengerService;
		this.passengerPdfService = passengerPdfService;
	...
	public PaxDetailPdfDocResponse createPassengerEventReport(Long paxId, Long flightId) {
		...
		try {
			paxDetailPdfDocResponse = passengerPdfService.createPaxDetailReport(paxDetailPdfDocRequest);
		}
