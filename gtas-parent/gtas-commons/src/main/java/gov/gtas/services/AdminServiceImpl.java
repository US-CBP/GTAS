...
public class AdminServiceImpl implements AdminService {
    ...
    public ApplicationStatisticsDTO createApplicationStatisticsDto() {
        ...
        messageList.stream().findFirst().ifPresent(m ->
                applicationStatisticsDTO.setLastMessageInSystem(m.getCreateDate())
        );
    ...
    protected void populateApplicationStatistics(ApplicationStatisticsDTO applicationStatisticsDTO, List<MessageStatus> msList) {
            ...
            switch(ms.getMessageStatusEnum()) {
               ...
               case LOADED:
                ...
                case RUNNING_RULES:
                    ...
                    break;
                case ANALYZED:
                    if (ms.getAnalyzedTimestamp() != null && ms.getAnalyzedTimestamp().after(applicationStatisticsDTO.getLastMessageAnalyzedByDrools())) {
                ...
                case PARTIAL_ANALYZE:
                    applicationStatisticsDTO.setPartialAnalyzedCount(applicationStatisticsDTO.getPartialAnalyzedCount() + 1);
                    break;
                default:
