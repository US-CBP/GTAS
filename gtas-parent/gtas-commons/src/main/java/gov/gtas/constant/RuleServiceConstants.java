...
public class RuleServiceConstants {
	...
	/*
	 * All generated rules depend on this global object for returning results. When
	 * a knowledge session is created the global object should be created and
	 * associated with the session:
	 * ksession.setGlobal(RuleServiceConstants.RULE_RESULT_LIST_NAME, new
	 * ArrayList<Object>()); The global can then be accessed after the rules are run
	 * by: (List<?>) ksession.getGlobal(RuleServiceConstants.RULE_RESULT_LIST_NAME);
	 */
	...
	/*
	 * This is the error code for an internal system error indicating that the UDR
	 * generated rule could not be compiled.
	 */
	public static final String RULE_COMPILE_ERROR_CODE = "RULE_COMPILE_ERROR";

	/*
	 * This is the error code for an internal system error indicating that the UDR
	 * generated knowledge base could not be retrieved from the data base.
	 */
	public static final String KB_NOT_FOUND_ERROR_CODE = "KB_NOT_FOUND";
	/*
	 * This is the error code for an internal system error indicating that an API or
	 * PNR message intended for processing could not be retrieved from the data
	 * base.
	 */
	public static final String MESSAGE_NOT_FOUND_ERROR_CODE = "MESSAGE_NOT_FOUND";
	/*
	 * This is the error code for an internal system error indicating that the UDR
	 * generated knowledge base retrieved from the data base has invalid content.
	 */
	public static final String KB_INVALID_ERROR_CODE = "KB_INVALID_ERROR";
	/*
	 * This is the error code for an internal system error indicating that the UDR
	 * generated knowledge base could not de-serialized from the DB record.
	 */
	...
	/*
	 * This is the error messsage for an internal system error indicating that an
	 * API or PNR message intended for processing could not be retrieved from the
	 * data base.
	 */
	...
	/*
	 * This error message indicates that the indicated knowledge base contains no
	 * enabled rule.
	 */
