...
public class RuleErrorConstants {
	...
	/*
	 * The Input JSON Query Specification from UI is missing the rule title in the
	 * meta data summary.
	 */
	public static final String NO_TITLE_ERROR_CODE = "NO_TITLE";

	/*
	 * The Input JSON Query Specification from UI is missing the start date in the
	 * meta data summary or the start date is invalid.
	 */
	...
	/*
	 * The Input JSON Query Specification from UI has an invalid rule detail
	 * structure. (i.e., it is not a valid boolean tree structure.)
	 */
