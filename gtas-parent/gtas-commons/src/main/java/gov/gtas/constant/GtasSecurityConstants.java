...
public class GtasSecurityConstants {
	...
	/*
	 * Admin has every permission in the entire system, this means that rather than
	 * double parameters for every Role section, we'll combine each individual
	 * permission with Admin There will no longer be multiple non-admin roles,
	 * bundled together.
	 */
	...
	// This enables the list of pax after a flight is selected to be displayed for
	// users with the permission Manage Queries
