...
public class SampleDataGenerator {
	...
	public static WatchlistSpec createSampleWatchlist(String wlName) {
		WatchlistSpec ret = new WatchlistSpec(wlName, EntityEnum.PASSENGER.getEntityName().toUpperCase());
		ret.addWatchlistItem(new WatchlistItemSpec(null, WatchlistEditEnum.C.getOperationName(),
				new WatchlistTerm[] {
						new WatchlistTerm(PassengerMapping.FIRST_NAME.getFieldName(),
								PassengerMapping.FIRST_NAME.getFieldType(), "John"),
						new WatchlistTerm(PassengerMapping.LAST_NAME.getFieldName(),
								PassengerMapping.LAST_NAME.getFieldType(), "Jones"),
						new WatchlistTerm(PassengerMapping.DOB.getFieldName(), PassengerMapping.DOB.getFieldType(),
								"1747-07-06") }));
		ret.addWatchlistItem(new WatchlistItemSpec(32L, WatchlistEditEnum.U.getOperationName(),
				new WatchlistTerm[] {
						new WatchlistTerm(PassengerMapping.FIRST_NAME.getFieldName(),
						...
						new WatchlistTerm(PassengerMapping.DOB.getFieldName(), PassengerMapping.DOB.getFieldType(),
								"1966-09-13") }));
		ret.addWatchlistItem(new WatchlistItemSpec(25L, WatchlistEditEnum.D.getOperationName(), null));
		return ret;
	}
