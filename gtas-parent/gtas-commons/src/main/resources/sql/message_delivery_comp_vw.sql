CREATE VIEW message_delivery_comp_vw AS
SELECT 
	 msg.id as id,
	...
	TIMESTAMPDIFF(HOUR, pnr.transmission_date, full_utc_etd_timestamp) as msg_trans_comp_hrs,
  TIMESTAMPDIFF(MINUTE, pnr.transmission_date, full_utc_etd_timestamp) as msg_trans_comp_mins	
...
SELECT 
 ...
 apm.transmission_date as transmission_date,
	...
	mfd.full_utc_eta_timestamp as full_utc_eta_timestamp,
	fpc.fp_count as passenger_count,
  TIMESTAMPDIFF(HOUR, apm.transmission_date, full_utc_etd_timestamp) as msg_trans_comp_hrs,
  TIMESTAMPDIFF(MINUTE, apm.transmission_date, full_utc_etd_timestamp) as msg_trans_comp_mins	
