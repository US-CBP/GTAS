  ...
  app.controller("FlightsController", function(
    ...
    var self = this,
      ...
      setFlightsGrid = function(grid, response) {
        var data =
          stateName === "queryFlights" ? response.data.result : response.data;
    ...
    $scope.flightsGrid.columnDefs = [
      ...
      },
      {
        ...
        enableFiltering: false,
        cellTemplate:
          "<span ng-class=\"{'text-success': row.entity.countDown.closeToCountDown}\">{{row.entity.countDown.countDownTimer}}</span>"
      },
      {
        name: "listHitCount",
        ...
        cellTemplate:
          '<span ng-if="row.entity.listHitCount" class="badge danger-back danger-border-th">{{row.entity.listHitCount}}</span>'
      },
      {
        name: "ruleHitCount",
        ...
        cellTemplate:
          '<span ng-if="row.entity.ruleHitCount" class="badge warning-back warning-border-th">{{row.entity.ruleHitCount}}</span>'
      },
      {
        name: "graphHitCount",
        ...
        cellTemplate:
          '<span ng-if="row.entity.graphHitCount" class="badge warning-back warning-border-th">{{row.entity.graphHitCount}}</span>'
      },
      {
        name: "fuzzyHitCount",
        ...
        cellTemplate:
          '<span ng-if="row.entity.fuzzyHitCount" class="badge info-back info-border-th">{{row.entity.fuzzyHitCount}}</span>'
      },
      {
        ...
        cellTemplate:
          '<span ng-if="row.entity.externalHitCount" class="badge warning-back warning-border-th">{{row.entity.externalHitCount}}</span>'
      },
      {
        name: "direction",
      ...
      {
        name: "origin",
        displayName: $translate.instant("flight.origin"),
        visible: true,
      ...
      {
        name: "originCountry",
        displayName: $translate.instant("doc.country"),
        visible: false,
        cellTemplate:
          '<md-button aria-label="hits" ng-mouseleave="grid.appScope.resetCountryTooltip()">' +
      ...
      {
        name: "destination",
        displayName: $translate.instant("flight.destination"),
        cellTemplate:
          '<md-button aria-label="hits" ng-mouseleave="grid.appScope.resetCountryTooltip()">' +
          '<md-tooltip class="multi-tooltip" md-direction="left"><div>{{grid.appScope.getCodeTooltipData(COL_FIELD,"airport")}}</div></md-tooltip>{{COL_FIELD}}' +
          "</md-button>",
      ...
      },
      {
        ...
        displayName: $translate.instant("pass.destination"),
        cellTemplate:
          '<md-button aria-label="hits" ng-mouseleave="grid.appScope.resetCountryTooltip()">' +
          '<md-tooltip class="multi-tooltip" md-direction="left"><div>{{grid.appScope.getCodeTooltipData(COL_FIELD,"country")}}</div></md-tooltip>{{COL_FIELD}}' +
          "</md-button>",
    ...
    $scope.passengerSubGridColumnDefs = [
      {
        ...
        cellTemplate:
          '<md-button aria-label="hits" ng-click="grid.api.expandable.toggleRowExpansion(row.entity)" disabled="{{row.entity.onRuleHitList|ruleHitButton}}"><span ng-if="row.entity.onRuleHitList" class="badge warning-back warning-border-th">{{+row.entity.onRuleHitList}}</span></md-button>'
      },
      {
        name: "onWatchList",
        displayName: $translate.instant("hit.watchlisthits"),
        ...
        cellTemplate:
          '<span ng-if="row.entity.onWatchListDoc || row.entity.onWatchList" class="badge danger-back danger-border-th">{{+row.entity.onWatchListDoc+row.entity.onWatchList}}</span>'
      },
      { name: "passengerType", displayName: $translate.instant("pass.type") },
      {
        name: "lastName",
        displayName: $translate.instant("pass.lastname"),
        cellTemplate:
          '<md-button aria-label="type" href="#/paxdetail/{{row.entity.id}}/{{row.entity.flightId}}" title="{{`msg.launchflightpax` | translate}}" target="pax.detail" class="md-primary md-button md-default-theme" >{{COL_FIELD}}</md-button>'
      },
      {
        name: "firstName",
