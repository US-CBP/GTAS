...
(function () {
    ...
    app.controller('SignupController',
        function($state, $scope, $rootScope, $q, $stateParams, userService, $mdToast, SignupService,
                 Session, sessionFactory, APP_CONSTANTS, USER_ROLES, $sessionStorage, $location, $interval,
                 $window, $translate, $cookies, $mdDialog, Idle, configService, $sce) {
		...
		$scope.signup = function(credentials) {
			...
			SignupService.signup(credentials).success(function (data, status) {
                if(data) {
                	...
                	formProcessing(true);
                	setMessage("Your sign up request has been submitted successfully. <br><br> Once it is reviewed and approved, you will receive a temporary password to login into GTAS. <br><br> -Thank you.");
                }   
