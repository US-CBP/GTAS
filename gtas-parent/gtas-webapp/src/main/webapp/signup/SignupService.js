...
(function() {
	'use strict';
	app.factory('SignupService', function($http, Session, $rootScope, $mdToast,
			APP_CONSTANTS, $location, $cookies) {
		var signupService = {};
		...
		signupService.isAuthorized = function(authorizedRoles) {
			...
			return (signupService.isAuthenticated() && authorizedRoles
					.indexOf(Session.userRoles) !== -1);
		};
