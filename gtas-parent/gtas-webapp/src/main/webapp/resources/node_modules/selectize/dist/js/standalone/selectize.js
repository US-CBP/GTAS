...
(function(root, factory) {
	...
	var Selectize = function($input, settings) {
		...
		self.settings.dropdownDirection = self.settings.dropdownDirection || 'auto'; //ADDED CODE
	...
	$.extend(Selectize.prototype, {
		...
		refreshOptions: function(triggerDropdown) {
			...
			self.positionDropdown(); //ADDED CODE
		},
		 ...
		 */
		setDropdownDirection: function (direction) { //ADDED CODE >
			...
			this.$dropdown.css({
				...
				left  : offset.left,
				top   : (direction === 'down') ?  offset.top : 'auto', //ADDED CODE AND ALTERED CODE <
				bottom: (direction === 'down') ? 'auto'  : offset.top,
			}).toggleClass('dropdown-up', (direction === 'down') ? false : true); //ADDED CODE AND ALTERED CODE >
		},
