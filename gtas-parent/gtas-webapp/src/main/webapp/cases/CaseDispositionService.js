...
(function() {
  "use strict";
  app.service("caseDispositionService", function($http, $q, Upload) {
    ...
    function getDefaultSort() {
      return [{ column: "countdown", dir: "asc" }];
    }
    ...
    function updateHitsDisposition(
      paramCaseId,
      paramFlight,
      paramPax,
      paramHit,
    ...
    function updateGeneralComments(caseId, comment, caseStatus) {
      const requestDto = {
        comment: comment,
        caseId: caseId,
