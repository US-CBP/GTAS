...
public class QueryPassengerResult extends BaseQueryResult {
	...
	public int hashCode() {
		...
		result = prime * result + ((documentIssuanceCountry == null) ? 0 : documentIssuanceCountry.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (documentIssuanceCountry == null) {
			if (other.documentIssuanceCountry != null)
				return false;
		} else if (!documentIssuanceCountry.equals(other.documentIssuanceCountry))
			return false;
