...
// TECHNICALLY NOT AN IT. This takes a very long time to run and is therefore
// classified as an IT.
public class LoaderWorkerThreadIT {
	...
	private Semaphore semaphore = new Semaphore(0); // 0 permits because loader queue thread manager will add acquire a
													// permit.
